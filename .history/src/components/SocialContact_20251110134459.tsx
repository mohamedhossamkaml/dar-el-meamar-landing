...
const SocialContact: React.FC<SocialContactProps> = ({ position = "left" }) => {
  ...
  return (
    <>
      {/* نسخة الديسكتوب: صف أيقونات */}
      <div
        className={`hidden md:flex fixed top-1/3 ${sideClass} flex-row gap-4 z-50`}
      >
        {/* Facebook */}
        <a
      ...
      {/* نسخة الموبايل: صف أيقونات تحت */}
      <div className="md:hidden fixed bottom-4 left-4 flex flex-row gap-3 z-50">
        {/* Facebook */}
        <a
          href="https://www.facebook.com/share/1CkkfEbiKA/"
          target="_blank"
