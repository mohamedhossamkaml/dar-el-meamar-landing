...
const Works = () => {
  ...
  return (
    <motion.section
      id="works"
      className="relative py-20 overflow-hidden text-white dark:text-gray-100 transition-colors duration-300
                 bg-gradient-to-br from-teal-600 to-teal-800 dark:from-gray-900 dark:to-gray-800"
    ...
    >
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-black opacity-50  bg-gradient-to-br from-teal-700/70 via-teal-800/85 to-teal-950/90
                      dark:from-slate-900/80 dark:via-slate-950/85 dark:to-slate-950/90" />
