      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full ">
        ...
        <motion.div
          ...
          className="flex items-center justify-center mt-20
             overflow-hidden rounded-2xl border-4 border-white shadow-lg
             w-full bg-gradient-to-br from-teal-400/40 to-blue-500/40
             dark:from-teal-900/40 dark:to-blue-900/40 transition-colors duration-300"
          style={{
            minHeight: '400px',
            maxHeight: '700px',
            padding: '2rem', // 👈 margin داخلي بين Stack وحدود الديف
          }}
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
        ...
        >
          <Stack
            ...
            className="w-full h-full flex items-center justify-center bg-black/20 rounded-xl"
            style={{
              maxWidth: '100%',
              maxHeight: '100%',
              aspectRatio: '16 / 9',
              padding: '1rem', // 👈 margin داخلي للكروت نفسها
            }}
          />
        </motion.div>
