...
const Services = () => {
  ...
  return (
    <motion.section
      id="services"
      className="relative h-full min-h-screen flex flex-col justify-between py-10  items-center
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full ">
        ...
        <motion.div
          ...
          className="flex items-center justify-center mt-20
             ...
             h-[70vh] md:h-[80vh] lg:h-[90vh] p-90"
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
        >
          <Stack
            ...
            className="w-full md:w-9/12 lg:w-2/3 h-4/5 flex items-center justify-center"
          />
        </motion.div>
