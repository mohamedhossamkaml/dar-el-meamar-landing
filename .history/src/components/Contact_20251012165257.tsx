          ...
          >
            ...
            <motion.div className="flex items-start space-x-4" variants={fadeInUp}>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">{t("contact.info.phoneValue")}: +966 XX XXX XXXX</p>
              </div>
            </motion.div>
            ...
            <motion.div className="flex items-start space-x-4" variants={fadeInUp}>
              ...
              <div>
                <h3 className="font-bold text-gray-900 dark:text-white text-lg mb-1">{t("contact.email")}</h3>
            ...
            <motion.div className="flex items-start space-x-4" variants={fadeInUp}>
              ...
              <div>
                <h3 className="font-bold text-gray-900 dark:text-white text-lg mb-1">{t("contact.location")}</h3>
