      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full ">
        ...
        <motion.div
          ...
          className="relative flex items-center justify-center mt-20
             ...
             w-full h-[600px] md:h-[700px] lg:h-[800px] bg-gray-900/40"
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
        >
          <Stack
            ...
            className="w-full h-full"   // 👈 يخلي الـ Stack يملأ الـ div بالكامل
            style={{ borderRadius: '0.5rem' }} // 👈 تقدر تتحكم في الاستايل من برّه
          />
        </motion.div>
