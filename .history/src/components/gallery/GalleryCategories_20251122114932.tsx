...
const GalleryCategories: React.FC = () => {
  ...
  const categories = [
    { name: categoriesArr[0]?.name, icon: Building2, count: categoriesArr[0]?.count },
    { name: categoriesArr[1]?.name, icon: Home, count: categoriesArr[1]?.count },
    { name: categoriesArr[2]?.name, icon: Building, count: categoriesArr[2]?.count },
    { name: categoriesArr[3]?.name, icon: Factory, count: categoriesArr[3]?.count },
    { name: categoriesArr[4]?.name, icon: Hotel, count: categoriesArr[4]?.count },
  ];
