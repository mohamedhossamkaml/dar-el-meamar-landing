...
const GalleryProjects: React.FC = () => {
  ...
  const projects = [
    { ...t.galleryPage.projects[0], image: "/images/home.jpg", color: 'from-blue-400 to-blue-600' },
    { ...t.galleryPage.projects[1], image: "/images/building.jpg", color: 'from-teal-400 to-teal-600' },
    { ...t.galleryPage.projects[2], image: "/images/factory.jpg", color: 'from-purple-400 to-purple-600' },
    { ...t.galleryPage.projects[3], image: "/images/hotel.jpg", color: 'from-orange-400 to-orange-600' },
    { ...t.galleryPage.projects[4], image: "/images/villa.jpg", color: 'from-green-400 to-green-600' },
    { ...t.galleryPage.projects[5], image: "/images/apartment.jpg", color: 'from-pink-400 to-pink-600' },
          ...
          {projects.map((project: any, index: number) => (
            ...
            >
              <div className={`relative h-64 bg-gradient-to-br ${project.color} flex items-center justify-center overflow-hidden`}>
                <motion.div className="text-white/30" whileHover={{ scale: 1.1, rotate: 5 }} transition={{ duration: 0.3 }}>
