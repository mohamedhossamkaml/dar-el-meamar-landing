...
const GalleryProjects: React.FC = () => {
  ...
  const projects = [
    ...
    { ...t.galleryPage.projects[6], image: GALLERY_IMAGES[6], color: 'from-indigo-400 to-indigo-600' },
    { ...t.galleryPage.projects[7], image: GALLERY_IMAGES[7], color: 'from-cyan-400 to-cyan-600' },
    { ...t.galleryPage.projects[8], image: GALLERY_IMAGES[8], color: 'from-emerald-400 to-emerald-600' },
  ];
