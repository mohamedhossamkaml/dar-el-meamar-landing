...
const WorksTestimonials: React.FC = () => {
  ...
  // تحويل الـ object لـ Array علشان نقدر نعمل map
  const testimonialsRaw = t.worksPage?.testimonials ?? {};
  const testimonialsFromT = Array.isArray(testimonialsRaw)
    ? testimonialsRaw
    : Object.values(testimonialsRaw);
