        ...
        >
          {GALLERY_IMAGES.map((src, idx) => (
            <motion.div
             ...
             hover:shadow-2xl hover:text-teal-700  transition-all hover:-translate-y-1 hover:scale-105 dark:hover:shadow-teal-500/50 cursor-pointer group"
              style={{
            ...
            >
              ...
              >
                {/* Title */}
                <div className="text-3xl bg-teal-700/50 font-bold mb-2">
