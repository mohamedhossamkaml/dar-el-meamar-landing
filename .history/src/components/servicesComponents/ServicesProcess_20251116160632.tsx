...
const ServicesProcess: React.FC = () => {
  ...
  // get process steps data from translations
  const processSteps = Object.values(t.servicesPage?.processSteps || {}) as {
    number: string;
    title: string;
    description: string;
  }[];
        ...
        >
          {processSteps.map((step, index) => (
            <motion.div
              ...
              variants={scaleIn}
              className="
                bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg relative
            ...
            >
              <div
                className="
                  text-6xl font-bold text-teal-100 dark:text-gray-700
                  absolute top-6 opacity-50
