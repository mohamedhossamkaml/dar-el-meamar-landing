        ...
        >
          {GALLERY_IMAGES.map((src, idx) => (
            <motion.div
             ...
             hover:shadow-2xl transition-all hover:-translate-y-1 hover:scale-105 dark:hover:shadow-teal-500/50 cursor-pointer group"
              style={{
            ...
            >
              ...
              <motion.div
                variants={fadeInUp}
                className="relative z-10 text-center text-white group-hover:scale-110 transition-transform"
              >
                {/* Project Number */}
                <p className="font-semibold text-lg">{t.galleryPage.projects.map((_, idx) => idx + 1)[idx]} {idx + 1}</p>
              </motion.div>
            </motion.div>
