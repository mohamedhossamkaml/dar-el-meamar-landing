...
import { FaFacebookF, FaLinkedinIn, FaWhatsapp, FaInstagram, FaPhoneAlt } from "react-icons/fa";
import { FaXTwitter } from "react-icons/fa6";
import { FaPlus, FaTimes } from "react-icons/fa"; // زرار فتح/غلق
...
const SocialContact: React.FC<SocialContactProps> = ({ position = "left" }) => {
  ...
  return (
    <div className={`fixed bottom-4 ${sideClass} flex flex-col items-center gap-3 z-50`}>
      {/* زرار الفتح/الغلق */}
      <button
      ...
      {/* الأيقونات تظهر فقط لو open = true */}
      {open && (
