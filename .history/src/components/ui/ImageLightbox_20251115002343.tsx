          ...
          >
            {showArrows && (
              <button
                onClick={onPrev}
                aria-label="Previous"
                className="absolute left-2 top-1/2 -translate-y-1/2 z-20 p-2 rounded-full bg-black/40 dark:bg-white text-white hover:bg-black/60"
              >
                ‹
              </button>
            )}
            ...
            <button
              onClick={onClose}
              aria-label="Close"
              className="absolute right-2 top-2 z-20 p-2 rounded-full bg-black/40 text-white hover:bg-black/60"
            >
              ✕
            </button>
          </motion.div>
