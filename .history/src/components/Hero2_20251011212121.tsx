...
const Hero = () => {
  ...
  // نربط الـ scroll progress بالـ section ده
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: ["start end", "end start"],
    // "start end" = يبدأ لما السكشن يدخل الشاشة
    // "end start" = ينتهي لما يخرج من الشاشة
  });

  // نربط طول الـ path بنسبة التمرير
  ...
  return (
    ...
    >
      ...
      {/* SVG Path Animation مرتبط بالـ scroll */}
      <svg
