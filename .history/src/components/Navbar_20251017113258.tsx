  ...
  return (
    <motion.nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-transparent shadow-md dark:bg-transparent dark:shadow-[0_8px_30px_rgba(255,255,255,0.08)]'
    ...
    >
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="md:hidden bg-white/90 border-t dark:bg-gray-900/90 dark:border-gray-700"
            initial="hidden"
            animate="visible"
            exit="hidden"
            variants={fadeInUp}
