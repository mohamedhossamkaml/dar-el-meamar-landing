...
const SocialContact: React.FC<SocialContactProps> = ({ position = "left" }) => {
  ...
  return (
    <div className={`fixed top-1/3 ${sideClass} flex flex-col gap-4 z-50`}>
      ...
      { /* WhatsApp number 1 */}
      <a
        href="https://wa.me/201234567890" // Put your first number here
        target="_blank"
        rel="noopener noreferrer"
      ...
      {/* WhatsApp number 2 */}
      <a
        href="https://wa.me/201098765432" // Put your second number here
        target="_blank"
        rel="noopener noreferrer"
        className="bg-green-500 text-white p-3 rounded-full shadow-md hover:bg-green-600 transition"
      >
      ...
      {/* Call */}
      <a
        href="tel:+201234567890" // Put your phone number here
