...
import STACK_IMAGES from '../config/StackImages';
...
const Services = () => {
  ...
  return (
    <motion.section
      id="services"
      className="relative min-h-screen flex flex-col justify-between py-20 items-center
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Cards */}
        <motion.div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8" variants={staggerContainer}>
          {t.services.list.map((service, idx) => (
            ...
            >
              ...
              <motion.h3 variants={fadeInUp} className="text-xl font-bold text-gray-900 dark:text-white mb-2">
                {service.title}
              </motion.h3>
              <motion.p variants={fadeIn} className="text-gray-600 dark:text-gray-400 leading-relaxed">
                {service.desc}
              </motion.p>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="flex items-center justify-center mt-10 overflow-hidden w-full shadow-xl
