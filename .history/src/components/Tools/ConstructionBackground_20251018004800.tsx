...
const ConstructionBackground = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-end justify-around opacity-20 dark:opacity-12">
      ...
      {/* Crane */}
      <motion.div
        className="absolute top-8 right-24 opacity-20 dark:opacity-10 drop-shadow-xl"
