    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute inset-0 opacity-60 dark:opacity-40">
        {[...Array(12)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute w-2 h-2 bg-teal-500rounded-full shadow-sm"
            style={{
              left: `${4 + (i * 7.5)}%`,
              top: `${8 + (i % 5) * 18}%`,
            }}
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-end justify-around opacity-20 dark:opacity-20">
