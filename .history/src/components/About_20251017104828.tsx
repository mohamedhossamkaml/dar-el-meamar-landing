...
const About = () => {
  ...
  return (
    ...
    >
      {/* Container: centers content and controls horizontal padding */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Section Header */}
        {/* Section Header wrapper: heading, subtitle and see more button */}
        <motion.div
        ...
        {/* Info Cards Section */}
        {/* Info Cards grid: maps over cards from translations */}
        <motion.div
        ...
        >
          {t.about.cards.map((card, index) => (
            ...
            >
              {/* Card icon wrapper: colored square holding icon */}
              <motion.div
                variants={scaleIn}
        ...
        {/* Blueprint Animation Section: text + animation */}
        <motion.div
        ...
        >
          ...
          <motion.div
            {/* Animation container: holds blueprint animation */}
            className="bg-gradient-to-br from-blue-50 to-teal-50 dark:from-gray-800 dark:to-gray-900
