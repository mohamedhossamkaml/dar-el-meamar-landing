          ...
          {GALLERY_IMAGES.map((src, idx) => (
            <motion.div
              ...
              className="aspect-square bg-gradient-to-br from-teal-100 to-teal-200
                         dark:from-gray-800 dark:to-gray-700 cursor-pointer
                         rounded-xl shadow-lg hover:shadow-2xl dark:hover:shadow-teal-600/45 transition-all hover:-translate-y-1
