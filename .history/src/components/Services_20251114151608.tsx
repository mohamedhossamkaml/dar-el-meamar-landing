      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full ">
        ...
        <motion.div
          ...
          className="flex items-center justify-center mt-20
             ...
             w-full max-w-4xl bg-gradient-to-br from-gray-100 to-gray-200"
          style={{ height: 'auto', minHeight: '400px' }} // 👈 ارتفاع طبيعي بدون خنق
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.2 }}
        >
          <Stack
            ...
            style={{
              maxWidth: '100%',
              aspectRatio: '16 / 9', // 👈 يخلي الكارت شكله طبيعي
            }}
          />
        </motion.div>
