...
const isRTL = document?.documentElement?.dir === "rtl";
  ...
  return (
    <motion.section
      id="services"
      className="flex relative py-20 bg-gradient-to-br from-slate-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors duration-300"
    ...
    variants={
      idx % 3 === 0
        ? (isRTL ? fadeInRight : fadeInLeft)
        : idx % 3 === 1
        ? scaleIn
        : (isRTL ? fadeInLeft : fadeInRight)
    }
              className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-2xl dark:hover:shadow-teal-900 transition-all hover:-translate-y-1 border border-gray-100 dark:border-gray-700"
            >
              <motion.div
                variants={scaleIn}
