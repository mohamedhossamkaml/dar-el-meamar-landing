...
const Services = ({ withVanta }: Props) => {
  ...
  return (
    <motion.section
      id="services"
  className="relative min-h-screen py-20 bg-gradient-to-br from-slate-50 to-white
    ...
    >
      ...
      {/* Background Overlay */}
      <div className="absolute inset-0 w-full min-h-full bg-gradient-to-br from-teal-300 via-white to-teal-500
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {services.map((service, idx) => (
            <motion.div
              key={idx}
              variants={fadeInUp} // 👈 أنيميشن موحّد
              transition={{ delay: idx * 0.15 }} // 👈 تأخير تدريجي
