...
export const PROJECTS: Record<number, GalleryCategory> = {
  ...
  4: {
    exterior: toArray(import.meta.glob('../../assets/img/projectsImg/Villa 138/2- Exterior shots shots/*.{jpg,png}', { eager: true })),
  ...
  5: {
    exterior: toArray(import.meta.glob('../../assets/img/projectsImg/Villa 145/2- Exterior shots/*.{jpg,png}', { eager: true })),
    entrance: toArray(import.meta.glob('../../assets/img/projectsImg/Villa 145/3- Entrance/*.{jpg,png}', { eager: true })),
    sales: toArray(import.meta.glob('../../assets/img/projectsImg/Villa 145/4- Sales plans/*.{jpg,png}', { eager: true })),
  },
};
